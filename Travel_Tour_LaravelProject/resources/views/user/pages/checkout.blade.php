        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-3 col-sm-3 mg-bot15">
              ...
              <div>
                <input class="form-control" name="adult" type="text" value="1" />
              </div>
            </div>
            <div class="col-md-3 col-sm-3 mg-bot15">
              <label>Trẻ em</label>
              <div>
                <input class="form-control" name="children" type="text" value="0" />
              </div>
            </div>
            <div class="col-md-2 col-sm-3 mg-bot15">
              <label>Trẻ nhỏ</label>
              <div>
                <input class="form-control " id="small_children" name="small_children" type="text" value="0" />
              </div>
            </div>
            <div class="col-md-4 col-sm-3">
              <label>Số khách</label>
              <div>
                <input class="form-control" id="guests" name="guests" type="text" value="1" /> 
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
          ...
          <div style="line-height: 22px">
            ...
            - 
            <span class="bold">Trẻ nhỏ từ :</span> dưới 5 tuổi
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="form-horizontal">
              <div class="row mg-bot10">
                ...
                <div class="col-sm-2 col-xs-12 mg-bot10">
                  ...
                  <div>
                    <select class="form-control" name="loaikhach" ><option value="0">Người lớn</option>
                    </select>
